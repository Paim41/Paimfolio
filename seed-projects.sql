-- Run this in Supabase SQL Editor to populate your projects table.
-- Then the /work page and home page will display them automatically.

INSERT INTO projects (title, description, category, tech_stack, github_url, live_url, thumbnail_color, featured) VALUES
...
('Carrent SaaS',
 ...
 'from-sky-400/30 to-blue-400/30', true),
...
-- Landing Pages
('Bocah Trade',
 'A vibrant kids'' trading card marketplace landing page with animated product showcases, testimonials carousel, and countdown timers for live drops.',
